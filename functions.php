...
if (!function_exists('theme_preload_webfonts')) :
  ...
  {
?>
    <link rel="preload" href="<?php echo esc_url(get_theme_file_uri('assets/fonts/Poppins-Light.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    ...
    <link rel="preload" href="<?php echo esc_url(get_theme_file_uri('assets/fonts/Poppins-Medium.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="<?php echo esc_url(get_theme_file_uri('assets/fonts/Poppins-Bold.woff2')); ?>" as="font" type="font/woff2" crossorigin>
<?php
  }
endif;
